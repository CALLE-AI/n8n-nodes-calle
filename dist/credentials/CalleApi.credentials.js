        ...
        this.properties = [
            {
                ...
                required: true,
                default: '',
                description: 'Create or manage a key in the <a href="https://dashboard.heycall-e.com/account/api-keys" target="_blank">CALL-E dashboard</a>, then select <strong>Create API key</strong> in the upper-right corner.',
            },
            {
